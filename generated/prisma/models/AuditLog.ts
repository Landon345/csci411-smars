...
export type AuditLogScalarWhereWithAggregatesInput = {
  ...
  LogID?: Prisma.StringWithAggregatesFilter<"AuditLog"> | string
  ...
  IPAddress?: Prisma.StringWithAggregatesFilter<"AuditLog"> | string
...
export type AuditLogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"LogID" | "UserID" | "Action" | "IPAddress" | "Details" | "CreatedAt", ExtArgs["result"]["auditLog"]>
...
export interface AuditLogDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many AuditLogs and only return the `LogID`
   * const auditLogWithLogIDOnly = await prisma.auditLog.createManyAndReturn({
   *   select: { LogID: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more AuditLogs and only return the `LogID`
   * const auditLogWithLogIDOnly = await prisma.auditLog.updateManyAndReturn({
   *   select: { LogID: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AuditLogFieldRefs {
  readonly LogID: Prisma.FieldRef<"AuditLog", 'String'>
